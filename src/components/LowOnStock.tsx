...
const LowOnStock = ({ data }: { data: TItems[] | undefined }) => {
  ...
  return (
    <div className=" mt-5 lg:mt-0 rounded-md min-h-[120px] max-h-[120px]  lg:max-h-[250px] shadow-lg ">
      <h2 className="text-center font-medium text-[16px] shadow-md w-[300px] rounded-md bg-white">
        Low on Stock
      </h2>
      ...
      {lowStockItems === undefined || lowStockItems?.length === 0 ? (
        ...
        <>
          <div className="grid grid-cols-2 text-center px-8p pb-2 bg-white">
            <div className="font-medium">Product</div>
            <div className="font-medium">Stocks</div>
          </div>
          <div className="max-h-[65px] lg:max-h-[180px] px-8 overflow-auto bg-white bg-opacity-50">
